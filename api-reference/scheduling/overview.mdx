...
- **One-Off Task**: Automatically set as a one-time execution
...
✅ **One-Off Tasks**: Support for single-execution schedules  
✅ **Status Management**: Active, inactive, paused, completed, expired states  
✅ **Template Variables**: Dynamic content in scheduled workflows  
