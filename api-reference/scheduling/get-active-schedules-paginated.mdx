---
title: 'Get Active Schedules (Paginated)'
openapi: 'GET /v1/api/get_active_schedules_paginatated/'
---
...
```bash cURL
curl -X GET "https://api.hookpulse.io/v1/api/get_active_schedules_paginatated/?filter_status=active&page=1" \
...
const page = 1;
const response = await fetch(`https://api.hookpulse.io/v1/api/get_active_schedules_paginatated/?filter_status=${filterStatus}&page=${page}`, {
  method: 'GET',
  headers: {
...
url = 'https://api.hookpulse.io/v1/api/get_active_schedules_paginatated/'
headers = {
    'x-hookpulse-api-key': '{{x-hookpulse-api-key}}',
    'x-brand-uuid': '{{x-brand-uuid}}'
}
...
uri = URI('https://api.hookpulse.io/v1/api/get_active_schedules_paginatated/')
...
$filterStatus = 'active';
$page = 1;
$url = "https://api.hookpulse.io/v1/api/get_active_schedules_paginatated/?filter_status=" . urlencode($filterStatus) . "&page=" . urlencode($page);
...
```bash
GET /v1/api/get_active_schedules_paginatated/?filter_status=active&page=1
```

### Get All Paused Schedules
```bash
GET /v1/api/get_active_schedules_paginatated/?filter_status=paused&page=1
```

### Get All Completed Schedules
```bash
GET /v1/api/get_active_schedules_paginatated/?filter_status=completed&page=1
```

### Get All Inactive Schedules
```bash
GET /v1/api/get_active_schedules_paginatated/?filter_status=inactive&page=1
```

### Get All Expired Schedules
```bash
GET /v1/api/get_active_schedules_paginatated/?filter_status=expired&page=1
```
